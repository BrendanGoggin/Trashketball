...
var FONT_HEIGHT = 60;
var LEVEL_FONT = "" + FONT_HEIGHT + "px Georgia";
var TEXT_COLOR = "";
...
class Menu extends DisplayObjectNode {
    ...
    static makeLevel(levelNumber, levelCount) {
        ...
        levelNode.font = LEVEL_FONT;
        var spacing = 10;
        var paddingTop = 15;
        var paddingBottom = 15;
        var levelPositionX = 70;
        var levelPositionY = (((600.0 - paddingTop - paddingBottom) / levelCount) * levelNumber) + spacing + FONT_HEIGHT + paddingTop;
